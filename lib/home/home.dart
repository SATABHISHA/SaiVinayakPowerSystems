    ...
    return Material(
      child: Scaffold(
        ...
        decoration: BoxDecoration(
          ...
          child: MediaQuery.of(context).size.width > 980 ? ListView(
            shrinkWrap: true,
                                  ...
                                  Padding(
                                    ...
                                    child: DefaultTextStyle(
                                        ...
                                        child: AnimatedTextKit(
                                          totalRepeatCount: 1,
                                          animatedTexts: [
                                            TyperAnimatedText('Sai Vinayak Power Systems', textAlign: TextAlign.center)
                                          ],
                                        )),
                                  ),
                                  // SizedBox(width: 10,),
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text('List of Machineries', style: TextStyle(color: Color.fromRGBO(23, 23, 23, 1.0), fontSize: 20, fontWeight: FontWeight.w700)),
                            SizedBox(height: 10,),
                            Expanded(
                              child: Padding(
                                padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text('Our Clients', style: TextStyle(color: Color.fromRGBO(23, 23, 23, 1.0), fontSize: 20, fontWeight: FontWeight.w700)),
                            SizedBox(height: 10,),
                            Expanded(
                              child: Padding(
                                padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
